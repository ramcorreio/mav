...
public class GeracaoTokenResposta extends MensagemBasica {

	private static final long serialVersionUID = -4962214624320654649L;
	...
	public GeracaoTokenResposta(String id, Cabecalho cabecalho) {
		super(id, cabecalho);
	}
