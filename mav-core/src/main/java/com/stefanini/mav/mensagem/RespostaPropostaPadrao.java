...
public abstract class RespostaPropostaPadrao extends MensagemBasica {

	private static final long serialVersionUID = 5241976079984601402L;
	...
	protected RespostaPropostaPadrao(String id, Cabecalho cabecalho) {
		super(id, cabecalho);
	}
