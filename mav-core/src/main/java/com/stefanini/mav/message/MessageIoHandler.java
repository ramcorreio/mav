...
import com.stefanini.mav.tcp.MessageRequest;
...
public class MessageIoHandler extends IoHandlerAdapter {
    ...
    public static final String INDEX_KEY = MessageIoHandler.class.getName() + ".INDEX";
    ...
    private BufferedImage createImage(MessageRequest request, String text) {
